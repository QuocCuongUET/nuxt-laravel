    ...
    <div class="row">
      <div class="col">
        <div class="text-center">
          <nuxt-link to="/products" class="btn btn-secondary m-1">Continue Shopping</nuxt-link>
          <nuxt-link to="/checkout" class="btn btn-primary m-1" v-bind:disabled="lines.length == 0">Checkout</nuxt-link>
        </div>
      </div>
    </div>
  </div>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapState('cart', { lines: state => state.lines }),
